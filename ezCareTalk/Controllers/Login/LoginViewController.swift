...
class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Swift
        // // Add this to the header of your file, e.g. in ViewController.swift import FBSDKLoginKit // Add this to the body class ViewController: UIViewController { override func viewDidLoad() { super.viewDidLoad()
        ...
        facebookRequest.start(completionHandler: { _, result, error in
            ...
            FirebaseAuth.Auth.auth().signIn(with: credential, completion: { [weak self] authResult, error in
                ...
                guard authResult != nil, error == nil else {
                    if let error = error {
                    print("Faacebook credential login failed, MFA may be needed - \(error)")
